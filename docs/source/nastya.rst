...
.. list-table:: Таблица в виде списка
   ...
   * - destAddr
     - string
     - Номер телефона абонента. Примеры: 72101234567, +72101234567, 8-210-123-45-67, 82101234567. .. note:: При отсутствии параметра message/data/externalUserId для Push-сообщений является обязательным
     - ``+``
...
.. csv-table:: CSV-таблица
   ...
   "destAddr", "string", "Номер телефона абонента. Примеры: 72101234567, +72101234567, 8-210-123-45-67, 82101234567. 
   .. note:: При отсутствии параметра message/data/externalUserId для Push-сообщений является обязательным", ``+``
